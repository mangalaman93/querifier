 ...
 * @author amitpanghal
 */
@WebServlet(name = "createReplyForm", urlPatterns = {"/createReplyForm"})
public class createReplyForm extends HttpServlet {
   ...
   private static final String SERVER = "localhost";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null && session.getAttribute("loggedin") != null && session.getAttribute("loggedin").equals("true")) {
            ...
            try {
                con = connect();
                out.println("<form name=\"replyAdd\"  method=\"post\" onsubmit=\"return submitReply("+news_ID+")\" >");
                ...
                out.println("<input type=\"button\" value=\"Cancel\" onclick=\"getNews("+news_ID+")\">");
                out.println("</form>");
            } catch (Exception e) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(createReplyForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
